...
//$mysc2_script[] = "create table meta_version (version varchar(5));";

$mysc2_script[] = "delete from meta_version;";

$mysc2_script[] = "insert into meta_version (version) values ('$mysc2_meta_ver');";
/*
$mysc2_script[] = "CREATE TABLE users_tmp ( 
   ...
   agreetc         INTEGER,
    region          VARCHAR( 5 ),
    country         VARCHAR( 100 )  DEFAULT 'Earth',
    notify_local_t  INTEGER,
    notify_online_t INTEGER
);";

$mysc2_script[] = "insert into users_tmp (user_id,username,password,sc2nick,pref_race,email,active,char_code,pic_id,descr,agreetc,region,country,notify_local_t,notify_online_t) select user_id,username,password,sc2nick,pref_race,email,active,char_code,pic_id,descr,agreetc,region,country,notify_local_t,notify_online_t from users;";
$mysc2_script[] = "drop table users;";

$mysc2_script[] = "CREATE TABLE users ( 
    user_id         INTEGER         PRIMARY KEY
                                    NOT NULL
                                    UNIQUE,
    username        VARCHAR( 15 )   NOT NULL,
...
$mysc2_script[] = "insert into users (user_id,username,password,sc2nick,pref_race,email,active,char_code,pic_id,descr,agreetc,region,country,notify_local_t,notify_online_t) select user_id,username,password,sc2nick,pref_race,email,active,char_code,pic_id,descr,agreetc,region,country,notify_local_t,notify_online_t from users_tmp;";

$mysc2_script[] = "drop table users_tmp;";

/*
$mysc2_script[] = "drop table country;";

$mysc2_script[] = "CREATE TABLE country (
...
$mysc2_script[] = "INSERT INTO country VALUES ('EA','EARTH','Earth','EA','000'); 
INSERT INTO country VALUES ('AP','AIUR','Aiur','AP','000');
INSERT INTO country VALUES ('ZC','CHAR','Char','ZC','000');
...
$mysc2_script[] = "INSERT INTO country VALUES ('AI','ANGUILLA','Anguilla','AIA','660');
...
$mysc2_script[] = "INSERT INTO country VALUES ('BA','BOSNIA AND HERZEGOVINA','Bosnia and Herzegovina','BIH','070');
...
$mysc2_script[] = "INSERT INTO country VALUES ('CD','CONGO, THE DEMOCRATIC REPUBLIC OF THE','Congo, the Democratic Republic of the','COD','180');
...
INSERT INTO country VALUES ('CI','COTE DIVOIRE','Cote DIvoire','CIV','384');
...
$mysc2_script[] = "INSERT INTO country VALUES ('FJ','FIJI','Fiji','FJI','242');
...
$mysc2_script[] = "INSERT INTO country VALUES ('IN','INDIA','India','IND','356');
...
INSERT INTO country VALUES ('KP','KOREA, DEMOCRATIC PEOPLES REPUBLIC OF','Korea, Democratic Peoples Republic of','PRK','408');
...
INSERT INTO country VALUES ('LA','LAO PEOPLES DEMOCRATIC REPUBLIC','Lao Peoples Democratic Republic','LAO','418');
...
$mysc2_script[] = "INSERT INTO country VALUES ('MY','MALAYSIA','Malaysia','MYS','458');
...
$mysc2_script[] = "INSERT INTO country VALUES ('PK','PAKISTAN','Pakistan','PAK','586');
...
$mysc2_script[] = "INSERT INTO country VALUES ('SJ','SVALBARD AND JAN MAYEN','Svalbard and Jan Mayen','SJM','744');
...
$mysc2_script[] = "CREATE TABLE replays ( 
    ...
    won           INTEGER,
    your_race     VARCHAR( 10 ),
    opponent_race VARCHAR( 10 ),
    game_type     VARCHAR( 3 ) 
);";

$mysc2_script[] = "CREATE TABLE replay_comments ( 
...
$mysc2_script[] = "CREATE TABLE replay_ratings ( 
...
$mysc2_script[] = "CREATE TABLE user_ratings ( 
    rating_id      INTEGER  PRIMARY KEY
                            NOT NULL
                            UNIQUE,
...
*/
/*
$mysc2_script[] = "CREATE TABLE replays_tmp ( 
    replay_id     INTEGER         PRIMARY KEY
                                  NOT NULL
                                  UNIQUE,
    user_id       INTEGER         NOT NULL,
...
$mysc2_script[] = "insert into replays_tmp (replay_id,user_id,replay_name,replay_descr,need_help,dt_entered,filename,won,your_race,opponent_race,game_type) select replay_id,user_id,replay_name,replay_descr,need_help,dt_entered,filename,won,your_race,opponent_race,game_type from replays";
$mysc2_script[] = "drop table replays;";
...
$mysc2_script[] = "CREATE TABLE replays ( 
    ...
    opponent_race VARCHAR( 10 ),
    game_type     VARCHAR( 3 ) ,
	oppenent_name  VARCHAR( 50 )
);";

$mysc2_script[] = "insert into replays (replay_id,user_id,replay_name,replay_descr,need_help,dt_entered,filename,won,your_race,opponent_race,game_type) select replay_id,user_id,replay_name,replay_descr,need_help,dt_entered,filename,won,your_race,opponent_race,game_type from replays_tmp";
$mysc2_script[] = "drop table replays_tmp;";
*/
?>