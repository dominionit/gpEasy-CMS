...
<form action="<?php	echo $_SERVER ['REQUEST_URI']?>"  method="post" id="management">
  <p><h1>Media Player - by <a href='http://www.dominion-it.co.za'>Dominion IT</a></h1><br/>How  to use the plugin : <br/>Just add anywhere in your page  the following tag  (% mp3:filename %) <br/>
	 ...
	 uploads then the tag will be <br/><b>(% mp3:My personal Song.mp3 %)</b>.
	 <br/><br/>Also NOTE : If you want to put in multiple files in 1 player (playlist)<br/> seperate file names with <b>;</b><br/>
	 For example : (% mp3:My personal Song.mp3;OtherSong.mp3;Another One.mp3 %)<br/><br/>
     Version 1.0<br/>Note : Future versions will have beter config for the filenames and playlists.</p>
 <p>
